...
// Source: github.com/marten-seemann/qtls (interfaces: ClientSessionCache)
...
func (m *MockClientSessionCache) Get(arg0 string) (*ClientSessionState, bool) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", arg0)
	ret0, _ := ret[0].(*ClientSessionState)
	ret1, _ := ret[1].(bool)
	return ret0, ret1
}
...
func (m *MockClientSessionCache) Put(arg0 string, arg1 *ClientSessionState) {
	m.ctrl.T.Helper()
