...
func TestCloneNonFuncFields(t *testing.T) {
	...
	for i := 0; i < typ.NumField(); i++ {
		...
		case "Time", "GetCertificate", "GetConfigForClient", "VerifyPeerCertificate", "GetClientCertificate", "GetExtensions", "ReceivedExtensions", "Accept0RTT", "Rejected0RTT", "GetAppDataForSessionState", "SetAppDataFromSessionState":
